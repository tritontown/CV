...
def main():
	...
	camera_params = (333.71994064649397,332.3864141021737,328.90247793390785,221.06175468227764)
	tag_size = 70
	...
	while (True):
		try:
			...
			'''
			if result: 
				pose, e0, e1 = detector.detection_pose(result,camera_params,tag_size)
			...
			for i, detection in enumerate(result):
				...
				draw_pose(undistorted_img, camera_params,tag_size,pose)
